  ...
  <AppLayout>
    <div class="mx-auto max-w-4xl space-y-6">
      ...
      <form v-else @submit.prevent="saveSettings" class="space-y-6" novalidate>
        ...
        <div class="card">
          ...
          <div class="space-y-5 p-6">
            ...
            <template v-else>
              ...
              <div v-if="tlsFingerprintProfiles.length === 0" class="rounded border border-dashed border-gray-300 px-4 py-3 text-sm text-gray-500 dark:border-dark-600 dark:text-gray-400">
                ...
                <table class="min-w-full divide-y divide-gray-200 dark:divide-dark-600">
                  ...
                  <tbody class="divide-y divide-gray-200 bg-white dark:divide-dark-700 dark:bg-dark-900">
                    <tr v-for="profile in tlsFingerprintProfiles" :key="profile.profile_id">
                      ...
                      <td class="px-4 py-3 align-top">
                        <span class="rounded-full px-2.5 py-1 text-xs font-medium" :class="profile.enabled ? 'bg-emerald-100 text-emerald-700 dark:bg-emerald-500/15 dark:text-emerald-300' : 'bg-gray-100 text-gray-600 dark:bg-dark-700 dark:text-gray-300'">
                      ...
                      <td class="px-4 py-3 align-top">
                        <div class="flex flex-wrap gap-2">
                          ...
                          <button type="button" class="btn btn-secondary btn-xs" :disabled="tlsFingerprintSaving" @click="toggleTLSFingerprintProfile(profile)">
                            {{ profile.enabled ? t('admin.settings.tlsFingerprint.disableProfile') : t('admin.settings.tlsFingerprint.enableProfile') }}
                          </button>
                          <button type="button" class="btn btn-danger btn-xs" :disabled="tlsFingerprintSaving" @click="deleteTLSFingerprintProfile(profile)">
                            {{ t('common.delete') }}
                          </button>
                        </div>
                      </td>
        ...
        <div v-if="showTLSFingerprintModal" class="fixed inset-0 z-50 flex items-center justify-center p-4" @mousedown.self="closeTLSFingerprintModal">
            ...
            <div class="space-y-4 px-6 py-5">
              <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
                <div>
                  ...
                  <input v-model="tlsFingerprintForm.profile_id" type="text" class="input" :disabled="Boolean(editingTLSFingerprintProfileID)" />
                </div>
                <div>
                  <label class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300">
              ...
              <div>
                ...
                <textarea v-model="tlsFingerprintForm.cipher_suites_text" rows="3" class="input min-h-[84px]" :placeholder="t('admin.settings.tlsFingerprint.numberListPlaceholder')"></textarea>
              ...
              <div>
                ...
                <textarea v-model="tlsFingerprintForm.curves_text" rows="3" class="input min-h-[84px]" :placeholder="t('admin.settings.tlsFingerprint.numberListPlaceholder')"></textarea>
              </div>
              ...
              <div>
                ...
                <textarea v-model="tlsFingerprintForm.point_formats_text" rows="2" class="input min-h-[64px]" :placeholder="t('admin.settings.tlsFingerprint.numberListPlaceholder')"></textarea>
              </div>
            </div>
