  ...
  admin: {
    ...
    dataManagement: {
      ...
      batchOps: {
        ...
        refreshReferenceData: '刷新分组/代理',
        proxyOccupied: '占用 {count}',
        sourceLabel: '来源：{sources}',
        showFirstN: '只展示前 {count} 个',
        showRawMatches: '查看部分原始命中日志',
        fieldEmptyIdentity: '(空标识)',
        targetGroupRequired: '请先选择目标分组',
        targetProxyRequired: '请先选择目标代理',
        loadReferenceDataFailed: '读取分组和代理列表失败',
        status: {
          all: '全部状态',
          active: '正常',
          inactive: '禁用',
        ...
        ungrouped: {
          title: '1. 未分组账号批量入组',
          description: '预览当前未纳入任何分组的账号，再一键写入目标分组。',
          recentPreview: '最近预览 {count} 个账号',
          selectTargetGroup: '选择目标分组',
          allPlatforms: '全部平台',
          searchPlaceholder: '搜索账号名称 / 邮箱',
          preview: '预览未分组账号',
          previewing: '预览中...',
          apply: '批量写入分组',
          applying: '执行中...',
          total: '共 {count} 个未分组账号',
          previewSuccess: '已找到 {count} 个未分组账号',
          previewFailed: '预览未分组账号失败',
          applyingTitle: '正在批量写入分组',
          applyingSubtitle: '将未分组账号写入目标分组',
          applied: '已写入 {count} 个账号',
          targetGroup: '目标分组：#{id} {name}',
          applyFailed: '批量写入分组失败'
        },
        proxyMigration: {
          title: '2. 代理迁移后批量删除',
          description: '读取旧代理占用账号，批量迁移到新代理后删除旧代理。',
          sourceProxyIdsPlaceholder: '待删除代理 ID，支持逗号/换行，例如：12,13,18',
          selectTargetProxy: '选择目标代理',
          preview: '预览占用账号',
          previewing: '预览中...',
          apply: '迁移账号并删除代理',
          applying: '执行中...',
          hitAccounts: '命中 {count} 个账号',
          sourceProxies: '来源代理：{proxies}',
          sourceProxyIdsRequired: '请至少填写一个待删除代理 ID',
          targetInsideSource: '目标代理不能包含在待删除代理里。',
          targetRequiredWithAffectedAccounts: '当前只支持迁移到指定代理，请先选择目标代理。',
          previewSuccess: '命中 {count} 个账号',
          previewFailed: '预览代理迁移失败',
          confirm: '确认把 {proxyIds} 上的账号迁移后删除这些代理吗？',
          applyingTitle: '正在迁移账号并删除代理',
          applyingSubtitle: '源代理：{proxyIds}',
          applied: '已处理 {count} 个账号',
          targetProxy: '目标代理：#{id}',
          applyFailed: '迁移账号并删除代理失败'
        },
        proxyHealth: {
          title: '3. 代理测活与自动迁移',
          description: '对指定代理批量测活，自动把不可用代理上的账号迁移到当前更健康、占用更低的代理。',
          sourceProxyIdsPlaceholder: '可选：只测这些代理，留空则测全部代理',
          preview: '预览测活与迁移计划',
          previewing: '测活中...',
          apply: '自动迁移不可用代理账号',
          applying: '执行中...',
          ...
          assignments: '迁移计划',
          unassigned: '无法迁移',
          moveAccounts: '迁移 {count} 个账号',
          testSuccess: '测活成功',
          testFailed: '测活失败',
          testFailedDefault: '代理测活失败',
          loadAffectedAccountsFailed: '读取占用账号失败',
          noMatchedProxyIds: '没有匹配到要测活的代理 ID。',
          noHealthyTargets: '没有足够的可用代理可接收这些不可用代理上的账号: {proxyIds}',
          previewSuccess: '已完成 {count} 个代理的测活预览',
          previewFailed: '代理测活预览失败',
          confirm: '确认自动迁移不可用代理上的账号吗？',
          applyingTitle: '正在迁移不可用代理账号',
          applyingSubtitle: '系统会优先选择更健康、占用更低的代理',
          applied: '已执行 {count} 组代理迁移',
          healthySummary: '健康代理 {count} 个',
          applyFailed: '自动迁移失败'
        },
        opsMigration: {
          title: '4. 502 / 错误日志批量换代理',
          description: '从请求错误、上游错误、请求明细或系统日志里找出报错账号，再批量更新代理。',
          selectTargetProxy: '选择目标代理',
          keywordPlaceholder: '关键字，默认 502',
          pagesPlaceholder: '扫描页数',
          preview: '预览异常账号',
          previewing: '扫描中...',
          apply: '批量更新这些账号的代理',
          applying: '执行中...',
          hitAccounts: '命中 {count} 个账号',
          targetRequiredWithAffectedAccounts: '命中账号后，请先选择目标代理。',
          previewSuccess: '已命中 {count} 个异常账号',
          previewFailed: '扫描异常日志失败',
          applyingTitle: '正在批量切换异常账号代理',
          applyingSubtitle: '关键字：{keyword}',
          applied: '已批量更新 {count} 个账号',
          applyFailed: '批量换代理失败'
        },
        duplicates: {
          title: '5. 重复账号检查与删除',
          description: '先按字段预览重复组，默认勾选每组里除保留项之外的账号，再按你的选择删除。',
          searchPlaceholder: '可选：缩小范围搜索',
          preview: '预览重复账号',
          previewing: '扫描中...',
          apply: '删除选中的重复账号 ({count})',
          applying: '删除中...',
          total: '共 {duplicates} 个重复账号，分成 {groups} 组',
          keepSmallestId: '默认保留每组 ID 最小的账号',
          keepId: '保留 #{id}',
          deleteCount: '待删 {count} 个',
          previewSuccess: '找到 {count} 个重复账号',
          previewFailed: '扫描重复账号失败',
          noSelection: '当前没有勾选任何待删除账号',
          confirm: '确认删除这 {count} 个重复账号吗？',
          applyingTitle: '正在删除重复账号',
          applyingSubtitle: '已选中 {count} 个账号',
          applied: '已删除 {count} 个重复账号',
          applyFailed: '删除重复账号失败'
        }
      },
      actions: {
        refresh: '刷新状态',
    ...
    accounts: {
      ...
      dataExportTaskQueued: '已开始后台导出',
      dataExportTaskQueuedHint: '后台正在整理账号与代理数据，完成后会自动开始下载',
      dataExportTaskRunning: '后台正在导出数据',
      dataExportTaskCollectingAccounts: '正在收集导出账号',
      dataExportTaskCollectingProxies: '正在收集关联代理',
      dataExportTaskSerializing: '正在生成导出文件',
      dataExportTaskCompleted: '导出文件已生成',
      dataExportTaskCompletedSummary: '共导出 {account_count} 个账号，关联 {proxy_count} 个代理',
      dataExportTaskFailed: '后台导出失败',
      dataExportTaskMissingDownload: '导出任务已完成，但下载链接不可用或已过期',
      dataImportTitle: '导入数据',
      dataImportHint: '上传导出的 JSON 文件以批量导入账号与代理。',
      dataImportWarning: '导入将创建新账号与代理；可在下方批量指定默认分组，未指定时保留导入数据内的分组配置。请确认已有数据不会冲突。',
      dataImportFile: '数据文件',
      ...
      dataImportFastPathSummary: '快速导入完成：已入队 {account_enqueued}，占位账号 {placeholder_created}，账号失败 {account_failed}，代理失败 {proxy_failed}',
      dataImportFastPathToast: '快速导入完成：已入队 {account_enqueued}，占位账号 {placeholder_created}，失败 {account_failed}',
      dataImportErrors: '失败详情',
      dataImportSuccess: '导入完成：账号创建 {account_created}，跳过 {account_skipped}，失败 {account_failed}',
      dataImportCompletedWithErrors: '导入完成但有错误：账号跳过 {account_skipped}，失败 {account_failed}，代理失败 {proxy_failed}',
      ...
      syncNow: '开始同步',
      syncing: '同步中...',
      syncingWithProgress: '同步中 {progress}%',
      ...
      refreshModelsFailed: '刷新模型列表失败',
      modelsFetchedAt: '模型列表 {time} 更新，共 {count} 个',
      modelsRefreshError: '模型拉取失败：{message}',
      batchTestAccounts: '批量测试账号',
      batchTestAccountsDone: '批量测试完成：成功 {success}，失败 {failed}',
      batchTestAccountsFailed: '批量测试账号失败',
      importBindGroups: '导入后绑定分组',
      importBindGroupsHint: '未设置时保持导入数据中的分组；设置后会作为批量默认分组应用到未单独指定分组的账号。',
      noAccountsYet: '暂无账号',
      ...
      oauth: {
        ...
        openai: {
          ...
          pleaseEnterAccessToken: '请输入至少一个 Access Token',
          sessionTokenAuth: '手动输入 ST',
          sessionTokenDesc: '输入您已有的 ChatGPT / Sora Session Token，支持批量输入（每行一个），系统将自动验证并创建账号。',
          sessionTokenPlaceholder: '粘贴您的 ChatGPT / Sora Session Token...\n支持多个，每行一个',
      ...
      gemini: {
        ...
        oauthType: {
          ...
          googleOneShortDesc: '个人账号',
          gcpTitle: 'GCP Code Assist',
          gcpDesc: '企业级，需要 GCP 项目',
          gcpBillingHint: '需要激活 GCP 项目并绑定信用卡',
          ...
          advancedOptions: '高级选项（自建 OAuth Client）',
          showAdvanced: '显示',
          hideAdvanced: '隐藏',
          badges: {
            recommended: '推荐',
        ...
        setupGuide: {
          ...
          links: {
            countryCheck: '检查归属地',
            updateCountryAssociation: '修改归属地',
    ...
    channels: {
      ...
      noChannelsYet: '暂无渠道',
      createFirstChannel: '创建第一个渠道以管理模型定价',
      groupsUnit: '个分组',
      pricingUnit: '条定价规则',
      statusActive: '启用',
      statusDisabled: '停用',
      ...
      form: {
        ...
        status: '状态',
        restrictModels: '限制模型',
        restrictModelsHint: '开启后，仅允许定价列表中的模型，其余模型将被拒绝。',
        billingModelSource: '计费依据',
        billingModelSourceHint: '控制定价查找时使用哪个模型名',
        billingModelSourceChannelMapped: '按渠道映射后的模型计费',
        billingModelSourceRequested: '按请求模型计费',
        billingModelSourceUpstream: '按最终上游模型计费',
        platformConfig: '平台配置',
        applyPricingToAccountStats: '将渠道定价应用到账号统计',
        applyPricingToAccountStatsDesc: '开启后，账号统计面板会按渠道定价规则估算消耗。',
        groups: '关联分组',
        selectedCount: '已选 {count} 个',
        noGroupsAvailable: '暂无可用分组',
        inOtherChannel: '已在“{name}”中',
        webSearchEmulation: 'Web 搜索模拟',
        webSearchEmulationHint: '仅在全局已启用时生效，主要用于 Anthropic 搜索类请求。',
        modelMapping: '模型映射',
        ...
        addRule: '添加规则',
        noRulesConfigured: '暂无规则配置',
        ruleName: '规则名称',
        ruleGroups: '规则分组',
        noGroupsInChannel: '当前渠道暂无分组',
        ruleAccounts: '规则账号',
        searchAccountPlaceholder: '搜索账号名称或 ID',
        ruleAccountsHint: '可额外指定账号维度的定价覆盖。',
        ruleModelPricing: '规则定价',
        pricingEntry: '定价配置',
        noModels: '未添加模型',
        models: '模型列表',
        modelsPlaceholder: '输入模型名后按回车添加，支持通配符 *',
        modelInputHint: '按 Enter 添加，支持粘贴批量导入。',
        billingMode: '计费模式',
      ...
      validation: {
        minNegative: '区间 #{index}: 最小 token 数 ({value}) 不能为负数',
        ...
        openEndedLast: '区间 #{index}: 无上限区间（最大 token 数为空）只能是最后一个',
    ...
    proxies: {
      ...
      autoMaintenance: {
        ...
        managePlans: '维护计划',
        runScopeTitle: '立即执行',
        runScopeHint: '默认使用当前选中的代理；如果未勾选任何代理，则扫描全部代理。当前选中 {count} 个。',
        createPlan: '新建计划',
        editPlan: '编辑计划',
        planName: '计划名称（可选）',
        cronPlaceholder: 'Cron 表达式，例如 */30 * * * *',
        sourceProxyIdsPlaceholder: '可选：限定代理 ID，支持逗号/换行；留空表示全量扫描',
        maxResults: '最大结果数',
        maxFailures: '失败自动暂停阈值',
        enabled: '启用计划',
        plans: '已有计划',
        noPlans: '暂无代理自动维护计划',
        defaultPlanName: '未命名计划',
        nextRun: '下次运行',
        results: '最近结果',
        resultStats: '检测 {checked} 个代理，健康 {healthy} 个，失败 {failed} 个，迁移账号 {moved} 个',
        createSuccess: '代理自动维护计划创建成功',
        updateSuccess: '代理自动维护计划更新成功',
        deleteSuccess: '代理自动维护计划删除成功',
        deleteConfirm: '确定删除这个代理自动维护计划吗？',
        runFailed: '代理自动维护执行失败'
      },
      ...
      batchInputHint: "支持 http、https、socks4、socks5 协议，格式：协议://[用户名:密码{'@'}]主机:端口",
    ...
    settings: {
      ...
      tlsFingerprint: {
        title: 'TLS 指纹 Profile',
        description: '在后台管理 TLS 指纹 Profile，新的上游请求会自动应用最新配置。',
        enabled: '启用 TLS 指纹管理',
        enabledHint: '关闭后回退为内置默认 TLS 指纹，不使用自定义 Profile。',
        newProfile: '新建 Profile',
        empty: '暂无 TLS 指纹 Profile，请先创建',
        createTitle: '新建 TLS 指纹 Profile',
        editTitle: '编辑 TLS 指纹 Profile',
        modalHint: '数组字段留空时表示沿用内置默认值。',
        profileID: 'Profile ID',
        profileName: 'Profile 名称',
        profileEnabled: '启用该 Profile',
        profileEnabledHint: '关闭后该 Profile 不参与账号散列分配。',
        enableProfile: '启用',
        disableProfile: '停用',
        enableGrease: '启用 GREASE',
        enableGreaseHint: '通常用于模拟 Chrome 风格握手，Node/Claude 风格通常关闭。',
        cipherSuites: 'Cipher Suites',
        curves: 'Curves',
        pointFormats: 'Point Formats',
        numberListPlaceholder: '多个数字用逗号或空格分隔，例如 4866, 4867, 4865',
        defaultHint: '留空表示使用内置默认值',
        defaultValues: '使用默认值',
        profileIDRequired: '请填写 Profile ID',
        profileNameRequired: '请填写 Profile 名称',
        invalidUint16: '字段中包含无效的 16 位整数：{value}',
        invalidUint8: '字段中包含无效的 8 位整数：{value}',
        profileCreated: 'TLS 指纹 Profile 创建成功',
        profileSaved: 'TLS 指纹 Profile 保存成功',
        profileDeleted: 'TLS 指纹 Profile 删除成功',
        saved: 'TLS 指纹全局设置已保存',
        saveFailed: '保存 TLS 指纹设置失败',
        deleteFailed: '删除 TLS 指纹 Profile 失败',
        deleteConfirm: '确定删除 TLS 指纹 Profile {profileID} 吗？',
        columns: {
          profile: 'Profile',
          status: '状态',
          grease: 'GREASE',
