  ...
  admin: {
    ...
    dataManagement: {
      ...
      batchOps: {
        ...
        description:
          'These tools bring the most-used local sub2apitool batch workflows into the admin console and reuse the existing official admin APIs without requiring extra Python tooling.',
        refreshReferenceData: 'Refresh Groups / Proxies',
        proxyOccupied: '{count} occupied',
        sourceLabel: 'Sources: {sources}',
        showFirstN: 'Showing first {count} only',
        showRawMatches: 'View some raw matched logs',
        fieldEmptyIdentity: '(empty identity)',
        targetGroupRequired: 'Please select a target group first',
        targetProxyRequired: 'Please select a target proxy first',
        loadReferenceDataFailed: 'Failed to load groups and proxies',
        status: {
          all: 'All statuses',
          active: 'Active',
          inactive: 'Disabled',
        ...
        duplicateFields: {
          display: 'Prefer display name',
          email: 'Email',
          name: 'Name',
          username: 'Username'
        },
        ungrouped: {
          title: '1. Bulk assign ungrouped accounts',
          description: 'Preview accounts that are not assigned to any group and write them into a target group in one step.',
          recentPreview: 'Recently previewed {count} accounts',
          selectTargetGroup: 'Select target group',
          allPlatforms: 'All platforms',
          searchPlaceholder: 'Search account name / email',
          preview: 'Preview ungrouped accounts',
          previewing: 'Previewing...',
          apply: 'Bulk assign group',
          applying: 'Running...',
          total: '{count} ungrouped accounts',
          previewSuccess: 'Found {count} ungrouped accounts',
          previewFailed: 'Failed to preview ungrouped accounts',
          applyingTitle: 'Assigning groups in bulk',
          applyingSubtitle: 'Writing ungrouped accounts into the target group',
          applied: 'Assigned {count} accounts',
          targetGroup: 'Target group: #{id} {name}',
          applyFailed: 'Failed to bulk assign groups'
        },
        proxyMigration: {
          title: '2. Delete proxies after migration',
          description: 'Read accounts occupied by old proxies, migrate them to a new proxy, then delete the old proxies.',
          sourceProxyIdsPlaceholder: 'Proxy IDs to delete, supports commas/newlines, e.g. 12,13,18',
          selectTargetProxy: 'Select target proxy',
          preview: 'Preview occupied accounts',
          previewing: 'Previewing...',
          apply: 'Migrate accounts and delete proxies',
          applying: 'Running...',
          hitAccounts: '{count} matched accounts',
          sourceProxies: 'Source proxies: {proxies}',
          sourceProxyIdsRequired: 'Please enter at least one proxy ID to delete',
          targetInsideSource: 'The target proxy cannot be one of the proxies being deleted.',
          targetRequiredWithAffectedAccounts: 'A target proxy is required before accounts can be migrated.',
          previewSuccess: '{count} matched accounts',
          previewFailed: 'Failed to preview proxy migration',
          confirm: 'Migrate accounts from {proxyIds} and then delete those proxies?',
          applyingTitle: 'Migrating accounts and deleting proxies',
          applyingSubtitle: 'Source proxies: {proxyIds}',
          applied: 'Processed {count} accounts',
          targetProxy: 'Target proxy: #{id}',
          applyFailed: 'Failed to migrate accounts and delete proxies'
        },
        proxyHealth: {
          title: '3. Proxy health checks and auto-migration',
          description: 'Batch-check selected proxies and automatically move accounts from unhealthy proxies to healthier, lower-usage proxies.',
          sourceProxyIdsPlaceholder: 'Optional: only test these proxies; leave empty to test all proxies',
          preview: 'Preview health checks and migration plan',
          previewing: 'Checking...',
          apply: 'Auto-migrate accounts from unhealthy proxies',
          applying: 'Running...',
          checkedProxies: 'Checked proxies',
          healthyProxies: 'Healthy proxies',
          assignments: 'Migration plan',
          unassigned: 'Unassignable',
          moveAccounts: 'Move {count} accounts',
          testSuccess: 'Health check passed',
          testFailed: 'Health check failed',
          testFailedDefault: 'Proxy health check failed',
          loadAffectedAccountsFailed: 'Failed to load affected accounts',
          noMatchedProxyIds: 'No proxy IDs matched for health checks.',
          noHealthyTargets: 'Not enough healthy proxies to receive accounts from these unhealthy proxies: {proxyIds}',
          previewSuccess: 'Completed preview for {count} proxies',
          previewFailed: 'Failed to preview proxy health checks',
          confirm: 'Automatically migrate accounts from unhealthy proxies?',
          applyingTitle: 'Migrating accounts from unhealthy proxies',
          applyingSubtitle: 'The system will prioritize healthier proxies with lower occupancy',
          applied: 'Executed {count} proxy migration assignments',
          healthySummary: '{count} healthy proxies',
          applyFailed: 'Auto-migration failed'
        },
        opsMigration: {
          title: '4. Bulk proxy switching from 502 / error logs',
          description: 'Find errored accounts from request errors, upstream errors, request details, or system logs, then update their proxies in bulk.',
          selectTargetProxy: 'Select target proxy',
          keywordPlaceholder: 'Keyword, defaults to 502',
          pagesPlaceholder: 'Pages to scan',
          preview: 'Preview affected accounts',
          previewing: 'Scanning...',
          apply: 'Bulk update proxies for these accounts',
          applying: 'Running...',
          hitAccounts: '{count} matched accounts',
          targetRequiredWithAffectedAccounts: 'Please select a target proxy once affected accounts are found.',
          previewSuccess: 'Matched {count} affected accounts',
          previewFailed: 'Failed to scan error logs',
          applyingTitle: 'Bulk switching proxies for affected accounts',
          applyingSubtitle: 'Keyword: {keyword}',
          applied: 'Bulk updated {count} accounts',
          applyFailed: 'Failed to bulk switch proxies'
        },
        duplicates: {
          title: '5. Duplicate account review and deletion',
          description: 'Preview duplicate groups by field first. By default, accounts other than the retained one in each group are selected for deletion.',
          searchPlaceholder: 'Optional: narrow scope by search',
          preview: 'Preview duplicate accounts',
          previewing: 'Scanning...',
          apply: 'Delete selected duplicate accounts ({count})',
          applying: 'Deleting...',
          total: '{duplicates} duplicate accounts in {groups} groups',
          keepSmallestId: 'Keeps the smallest ID in each group by default',
          keepId: 'Keep #{id}',
          deleteCount: '{count} to delete',
          previewSuccess: 'Found {count} duplicate accounts',
          previewFailed: 'Failed to scan duplicate accounts',
          noSelection: 'No accounts are selected for deletion',
          confirm: 'Delete these {count} duplicate accounts?',
          applyingTitle: 'Deleting duplicate accounts',
          applyingSubtitle: '{count} accounts selected',
          applied: 'Deleted {count} duplicate accounts',
          applyFailed: 'Failed to delete duplicate accounts'
        }
      },
      actions: {
    ...
    accounts: {
      ...
      dataExportTaskQueued: 'Background export started',
      dataExportTaskQueuedHint: 'The server is preparing the account export. Download will start automatically when ready.',
      dataExportTaskRunning: 'Exporting data in the background',
      dataExportTaskCollectingAccounts: 'Collecting accounts',
      dataExportTaskCollectingProxies: 'Collecting related proxies',
      dataExportTaskSerializing: 'Building export file',
      dataExportTaskCompleted: 'Export file is ready',
      dataExportTaskCompletedSummary: 'Exported {account_count} accounts with {proxy_count} related proxies',
      dataExportTaskFailed: 'Background export failed',
      dataExportTaskMissingDownload: 'The export finished, but the download link is unavailable or expired',
      dataImportTitle: 'Import Data',
      dataImportHint: 'Upload the exported JSON file to import accounts and proxies.',
      dataImportWarning: 'Import will create new accounts and proxies. You can set default groups below; when left empty, imported group bindings are preserved. Ensure existing data does not conflict.',
      ...
      dataImportFastPathSummary: 'Fast import completed: queued {account_enqueued}, placeholders {placeholder_created}, account failures {account_failed}, proxy failures {proxy_failed}',
      dataImportFastPathToast: 'Fast import completed: queued {account_enqueued}, placeholders {placeholder_created}, failures {account_failed}',
      ...
      dataImportCompletedWithErrors: 'Import completed with errors: accounts skipped {account_skipped}, failed {account_failed}, proxy failed {proxy_failed}',
      ...
      allGroups: 'All Groups',
      allPlans: 'All Plans',
      allOAuthTypes: 'All OAuth Types',
      planFree: 'Free',
      planPlus: 'Plus',
      planTeam: 'Team',
      tierIdPlaceholder: 'Tier ID',
      ...
      modelsFetchedAt: 'Models refreshed {time}, {count} total',
      modelsRefreshError: 'Model refresh failed: {message}',
      batchTestAccounts: 'Batch Test Accounts',
      batchTestAccountsDone: 'Batch test finished: {success} succeeded, {failed} failed',
      batchTestAccountsFailed: 'Failed to batch test accounts',
      importBindGroups: 'Bind groups after import',
      importBindGroupsHint: 'Leave empty to keep groups from the import file. When set, these groups become the default for imported accounts that do not define groups explicitly.',
      ...
      oauth: {
        ...
        openai: {
          ...
          accessTokenDesc: 'Paste Access Tokens directly to create accounts without the OAuth flow. Supports batch import, one token per line.',
          accessTokenLabel: 'Access Token',
          accessTokenPlaceholder: 'Paste Access Tokens, one per line',
          importAccessToken: 'Import Access Tokens',
          pleaseEnterAccessToken: 'Please enter at least one Access Token',
          sessionTokenAuth: 'Manual ST Input',
          sessionTokenDesc: 'Enter your existing ChatGPT / Sora Session Token(s). Supports batch input (one per line). The system will automatically validate and create accounts.',
          sessionTokenPlaceholder: 'Paste your ChatGPT / Sora Session Token...\nSupports multiple, one per line',
      ...
      gemini: {
        ...
        oauthType: {
          ...
          googleOneDesc: 'Personal account with Google One subscription quotas',
          googleOneShortDesc: 'Personal account',
          gcpTitle: 'GCP Code Assist',
          gcpDesc: 'Enterprise-grade, requires a GCP project',
          gcpBillingHint: 'Requires an active GCP project with billing enabled',
          ...
          advancedOptions: 'Advanced options (custom OAuth client)',
          showAdvanced: 'Show',
          hideAdvanced: 'Hide',
          badges: {
            ...
            personalUser: 'Recommended for individuals',
        ...
        setupGuide: {
          ...
          links: {
            ...
            updateCountryAssociation: 'Update country association',
    ...
    channels: {
      ...
      description: 'Manage channels and model pricing rules',
      ...
      deleteConfirm: 'Are you sure you want to delete channel "{name}"? This action cannot be undone.',
      noGroupsSelected: 'No groups selected for the {platform} platform. Please select at least one group or disable this platform.',
      emptyModelsInPricing: 'A pricing entry under {platform} has no models. Add models or remove the entry.',
      modelConflict: 'Model patterns "{model1}" and "{model2}" conflict because their match ranges overlap',
      mappingConflict: 'Mapping source patterns "{model1}" and "{model2}" conflict because their match ranges overlap',
      billingMode: {
        token: 'Token',
        perRequest: 'Per request',
      ...
      form: {
        ...
        applyPricingToAccountStats: 'Apply channel pricing to account stats',
        applyPricingToAccountStatsDesc: 'When enabled, the account stats panel estimates usage with the channel pricing rules.',
        groups: 'Associated Groups',
        selectedCount: '{count} selected',
        noGroupsAvailable: 'No groups available',
        inOtherChannel: 'In "{name}"',
        webSearchEmulation: 'Web Search Emulation',
        webSearchEmulationHint: 'Only works when the global switch is enabled, mainly for Anthropic search-style requests.',
        modelMapping: 'Model Mapping',
        ...
        noGroupsInChannel: 'No groups in this channel yet',
        ruleAccounts: 'Rule accounts',
        searchAccountPlaceholder: 'Search account name or ID',
        ruleAccountsHint: 'You can add account-level overrides on top of group-based pricing.',
        ruleModelPricing: 'Rule pricing',
        pricingEntry: 'Pricing Entry',
        noModels: 'No models added',
        models: 'Models',
        modelsPlaceholder: 'Enter a model name and press Enter. Wildcards * are supported',
        modelInputHint: 'Press Enter to add. Paste is also supported for batch import.',
        ...
        intervals: 'Context-based interval pricing (optional)',
        ...
        imageTiers: 'Image pricing tiers (per request)',
        perRequestPrice: 'Per-request price',
        resolution: 'Resolution',
        resolutionPlaceholder: '1K / 2K / 4K',
        tierLabel: 'Tier',
        min: 'Min',
        max: 'Max',
        inclusive: 'incl.',
        infinity: '∞',
        perRequestPriceRequired: 'Per-request/image billing requires either a default price or at least one pricing tier',
        unnamed: 'Unnamed'
      },
      validation: {
        minNegative: 'Interval #{index}: minimum token count ({value}) cannot be negative',
        ...
        openEndedLast: 'Interval #{index}: an open-ended interval (empty max token count) can only be the last one',
        overlap: 'Intervals #{prevIndex} and #{currentIndex} overlap: the previous upper bound ({prevMax}) is greater than the current lower bound ({currentMin})',
        priceNames: {
          input: 'Input price',
          output: 'Output price',
    ...
    proxies: {
      ...
      dataExport: 'Export',
      autoMaintenance: {
        title: 'Proxy Auto Maintenance',
        runNow: 'Auto Test & Migrate',
        managePlans: 'Maintenance Plans',
        runScopeTitle: 'Run Now',
        runScopeHint: 'Uses the currently selected proxies first. If none are selected, all proxies will be scanned. Currently selected: {count}.',
        createPlan: 'Create Plan',
        editPlan: 'Edit Plan',
        planName: 'Plan Name (optional)',
        cronPlaceholder: 'Cron expression, e.g. */30 * * * *',
        sourceProxyIdsPlaceholder: 'Optional: restrict to proxy IDs, comma/newline separated. Leave empty to scan all proxies.',
        maxResults: 'Max Results',
        maxFailures: 'Pause After Failures',
        enabled: 'Enable Plan',
        plans: 'Plans',
        noPlans: 'No proxy auto-maintenance plans yet',
        defaultPlanName: 'Unnamed Plan',
        nextRun: 'Next Run',
        results: 'Recent Results',
        resultStats: 'Checked {checked} proxies, healthy {healthy}, failed {failed}, moved {moved} accounts',
        createSuccess: 'Proxy maintenance plan created',
        updateSuccess: 'Proxy maintenance plan updated',
        deleteSuccess: 'Proxy maintenance plan deleted',
        deleteConfirm: 'Delete this proxy maintenance plan?',
        runFailed: 'Proxy maintenance run failed'
      },
      ...
      batchInputHint:
        "Supports http, https, socks4, socks5 protocols. Format: protocol://[user:pass{'@'}]host:port",
    ...
    ops: {
      ...
      systemLogs: {
        title: 'System Logs',
        description: 'Newest entries are shown first by default. Supports filtering, search, and cleanup by condition.',
        queue: 'Queue',
        written: 'Written',
        dropped: 'Dropped',
        failed: 'Failed',
        ...
        query: 'Query',
        reset: 'Reset',
        cleanupByFilter: 'Cleanup by current filter',
        ...
        resetConfirm: 'Roll back to startup configuration (env/yaml) and apply immediately?',
        resetSuccess: 'Rolled back to startup log configuration',
        resetFailed: 'Failed to roll back log configuration',
        cleanupConfirm: 'Clean up system logs using the current filters? This action cannot be undone.',
        cleanupSuccess: 'Cleanup completed. Deleted {count} log entries',
    ...
    settings: {
      ...
      tlsFingerprint: {
        ...
        description: 'Manage TLS fingerprint profiles in the admin panel. New upstream requests automatically use the latest configuration.',
        enabled: 'Enable TLS fingerprint management',
        enabledHint: 'When disabled, requests fall back to the built-in default TLS fingerprint instead of custom profiles.',
        newProfile: 'New Profile',
        empty: 'No TLS fingerprint profiles yet. Create one first.',
        createTitle: 'Create TLS Fingerprint Profile',
        editTitle: 'Edit TLS Fingerprint Profile',
        modalHint: 'Leave array fields empty to use the built-in defaults.',
        profileID: 'Profile ID',
        profileName: 'Profile Name',
        profileEnabled: 'Enable this profile',
        profileEnabledHint: 'Disabled profiles are excluded from account hash selection.',
        enableProfile: 'Enable',
        disableProfile: 'Disable',
        enableGrease: 'Enable GREASE',
        enableGreaseHint: 'Usually used for Chrome-like handshakes. Node/Claude-style handshakes usually keep this off.',
        cipherSuites: 'Cipher Suites',
        curves: 'Curves',
        pointFormats: 'Point Formats',
        numberListPlaceholder: 'Separate numbers with commas or spaces, e.g. 4866, 4867, 4865',
        defaultHint: 'Leave empty to use built-in defaults',
        defaultValues: 'Using defaults',
        profileIDRequired: 'Profile ID is required',
        profileNameRequired: 'Profile name is required',
        invalidUint16: 'Field contains an invalid 16-bit integer: {value}',
        invalidUint8: 'Field contains an invalid 8-bit integer: {value}',
        profileCreated: 'TLS fingerprint profile created',
        profileSaved: 'TLS fingerprint profile saved',
        profileDeleted: 'TLS fingerprint profile deleted',
        saved: 'TLS fingerprint settings saved',
        saveFailed: 'Failed to save TLS fingerprint settings',
        deleteFailed: 'Failed to delete TLS fingerprint profile',
        deleteConfirm: 'Delete TLS fingerprint profile {profileID}?',
        columns: {
          profile: 'Profile',
          status: 'Status',
          grease: 'GREASE',
