...
curl -sSL https://raw.githubusercontent.com/DR-lin-eng/sub2api/main/deploy/docker-deploy.sh -o docker-deploy.sh
...
1. Download the latest release from [GitHub Releases](https://github.com/DR-lin-eng/sub2api/releases)
