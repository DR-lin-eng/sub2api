...
func (s *stubAdminService) ListAccounts(ctx context.Context, page, pageSize int, platform, accountType, status, search, plan, oauthType, tierID string, groupID int64) ([]service.Account, int64, error) {
