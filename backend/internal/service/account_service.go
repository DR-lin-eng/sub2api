...
type AccountRepository interface {
	...
	ListWithFilters(ctx context.Context, params pagination.PaginationParams, platform, accountType, status, search, plan, oauthType, tierID string, groupID int64) ([]Account, *pagination.PaginationResult, error)
