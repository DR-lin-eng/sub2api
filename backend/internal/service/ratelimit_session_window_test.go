...
func (m *sessionWindowMockRepo) ListWithFilters(context.Context, pagination.PaginationParams, string, string, string, string, string, string, string, int64) ([]Account, *pagination.PaginationResult, error) {
	panic("unexpected")
}
