...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	accountTestService := service.NewAccountTestService(accountRepository, geminiTokenProvider, openAITokenProvider, antigravityGatewayService, httpUpstream, configConfig)
	...
	dashboardHandler.SetOpsService(opsService)
	...
	adminTaskStateRepo := repository.NewAdminTaskStateRepository(client, db)
	adminTaskStateCacheSetup := handler.ProvideAdminTaskStateCacheSetup(taskStateCache, adminTaskStateRepo)
